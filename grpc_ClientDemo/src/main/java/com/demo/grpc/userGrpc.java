...
public final class userGrpc {
  ...
  public static io.grpc.MethodDescriptor<com.demo.grpc.User.LogoutRequest,
      com.demo.grpc.User.APIRes> getLogoutMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.User.LogoutRequest, com.demo.grpc.User.APIRes> getLogoutMethod;
    if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
          userGrpc.getLogoutMethod = getLogoutMethod = 
              io.grpc.MethodDescriptor.<com.demo.grpc.User.LogoutRequest, com.demo.grpc.User.APIRes>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "user", "logout"))
              .setSampledToLocalTracing(true)
  ...
  public static final class userBlockingStub extends io.grpc.stub.AbstractStub<userBlockingStub> {
    ...
    /**
     */
    public com.demo.grpc.User.APIRes logout(com.demo.grpc.User.LogoutRequest request) {
      return blockingUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_REGISTER:
          serviceImpl.register((com.demo.grpc.User.RegisterRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.User.RegResponse>) responseObserver);
          break;
